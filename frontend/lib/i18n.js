...
export const reportI18n = {
  bg: {
    ...
    confidenceText:   'Одитът съчетава автоматизиран анализ на документи с последваща експертна човешка проверка, която гарантира пълно съответствие и валидиране на всички констатации спрямо изискванията на GDPR. Системата извършва оценка по 37 ясно дефинирани критерия, като се фокусира изцяло върху съответствието на документацията с приложимата регулаторна рамка, без да включва технически анализ на информационни системи.',
    website:          'Уебсайт',
  ...
  en: {
    ...
    confidenceText:   'The audit combines automated document analysis with subsequent expert human review, ensuring full compliance and validation of all findings against GDPR requirements. The system evaluates 37 clearly defined criteria, focusing exclusively on the compliance of the documentation with the applicable regulatory framework, without conducting a technical analysis of information systems.',
    website:          'Website',
    scanDate:         'Scan Date',
